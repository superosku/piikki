      ...
      <form className="basic-form" onSubmit={this.props.submitForm}>
        ...
        <div className="input-container">
          <input
            ...
            onChange={((event) => {
              this.props.updateFormData('email', event.target.value)
            })}
          />
        ...
        <select onChange={((event) => {
          this.props.updateFormData('type', event.target.value)
        })}>
        ...
        this.props.loading ?
          ...
          <table>
            ...
            {this.props.users.map(user => <tr key={user.id}>
              ...
              <td>
                <button onClick={() => {
                  const confirmationValue = confirm('Are you sure?')
                  if (confirmationValue === false) {
                    return
                  }
                  const url = `${API_URL}/teams/${this.props.teamSlug}/users/${user.id}`;
                  ...
                  axios.delete(url,
                    ...
                    showPopup({
                      'header': "Done",
                      'info': 'User removed from the team succesfully. Please refresh the page to see the change.',
                      'class': 'success'
                    });
                  }).catch(error => {
                    this.setState({
